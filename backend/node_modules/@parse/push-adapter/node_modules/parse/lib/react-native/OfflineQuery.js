...
function matchesKeyConstraints(className, object, objects, key, constraints) {
  ...
  for (var condition in constraints) {
    ...
    switch (condition) {
      ...
      case '$select':
        {
          var subQueryObjects = objects.filter(function (obj, _index, arr) {
      ...
      case '$dontSelect':
        {
          var _subQueryObjects = objects.filter(function (obj, _index, arr) {
            return matchesQuery(compareTo.query.className, obj, arr, compareTo.query.where);
          });
          for (var _i2 = 0; _i2 < _subQueryObjects.length; _i2 += 1) {
            var _subObject = transformObject(_subQueryObjects[_i2]);
            return !(0, _equals.default)(object[key], _subObject[compareTo.key]);
          }
          return false;
        }
      case '$inQuery':
        {
          var _subQueryObjects2 = objects.filter(function (obj, _index, arr) {
      ...
      case '$notInQuery':
        {
          var _subQueryObjects3 = objects.filter(function (obj, _index, arr) {
            return matchesQuery(compareTo.className, obj, arr, compareTo.where);
          });
      ...
      case '$geoWithin':
        {
          if (compareTo.$polygon) {
            ...
            var polygon = new _ParsePolygon.default(points);
          ...
          if (compareTo.$centerSphere) {
            ...
            var centerPoint = new _ParseGeoPoint.default({
              latitude: WGS84Point[1],
              longitude: WGS84Point[0]
            });
            var point = new _ParseGeoPoint.default(object[key]);
      ...
      case '$geoIntersects':
        {
          var _polygon = new _ParsePolygon.default(object[key].coordinates);
          var _point = new _ParseGeoPoint.default(compareTo.$point);
